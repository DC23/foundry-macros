/*
Performs an instant jump, advancing time. This is useful if no gameplay is taking place
inside the ship during the jump itself.
Note that the flag used by the show-jump-progress macro and related functionality is not set.
...
game.modules.get('jd-easytimekeeping').api.increment({hours: jumpDurationHours.total})
